from excepcion import MyCustomException

def ErrorBodega():
    raise MyCustomException("No hay suficientes unidades en bodega.")
...
class Cliente(PersonaNatural):
    ...
    def agregar_saldo(self, monto_agregado):
        ...
        try:
            ...
            print("Hay un problema con el tipo de dato para el saldo o el monto agregado.")
...
class Producto():
    ...
    def valor_impuesto(self):
        ...
        try:
            ...
            print("Parece que hay un problema con el impuesto. Por favor revisar que no sea igual a cero.")
    ...
    def procesar_carro(self, Cliente):
        ...
        for producto in Cliente.carro_compras:
            try:
                ...
                print("No se encontró el producto en el carro. Omitiendo.")
                pass
...
class Sucursal():
    ...
    def gestionar_stock(self, Bodega):
        ...
        if self.stock < 50:
            try:
                    self.reponer_stock()
            except MyCustomException as mensaje:
                print(mensaje)
